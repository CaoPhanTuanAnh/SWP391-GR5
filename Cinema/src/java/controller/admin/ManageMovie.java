...
public class ManageMovie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.printStackTrace();
            request.setAttribute("error", "Lỗi khi lấy danh sách phim: " + e.getMessage());
        }
        for (movies movie : list) {
            movie.setActorsString(String.join(", ", movie.getActors()));
            movie.setDirectorsString(String.join(", ", movie.getDirectors()));
        }
