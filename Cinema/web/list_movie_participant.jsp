...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Manage Movie Participant</title>
    ...
    <body onload="console.log('${requestScope.mess}')">
            ...
            <div class="table-responsive">
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Manage <b>Participant Role</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Movie Participant</span></a>						
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th style="width: 50px !important;">Movie ID</th>
                                <th style="width: 150px !important;">Movie Name</th>
                                <th style="width: 50px !important;">Participant ID</th>
                                <th style="width: 150px !important;">Participant Name</th>
                                <th style="width: 120px !important;">Role</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${movie_participantList}" var="movie_participant">
                                <tr>
                                    <td>${movie_participant.getMovie_id()}</td>
                                    <td>${movie_participant.getTitle()}</td>
                                    <td>${movie_participant.getParticipant_id()}</td>
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="movie_participant_control" method="post">
                        <input type="hidden" name="service" value="addMovie_participant">
                        <div class="modal-header">						
                            <h4 class="modal-title">Add New Movie Participant</h4>
        ...
        <div id="editEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="movie_participant_control" method="post">
                        <input type="hidden" name="service" value="editMovie_participant">
                        <div class="modal-header">						
                            <h4 class="modal-title">Edit Movie Participant</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">					
                            <div class="form-group">
