...
<html lang="vi">
    ...
    <body>
        ...
        <div class="d-flex justify-content-between flex-wrap container">
            <c:forEach items="${listPopulars}" var="branch">
                <div class="card branch-item" style="width:500px">
                    <img class="card-img-top img-branch"
                         src="${branch.getImg()}"
                         alt="Card image" style="width:100%">
                    <div class="card-body">
                        <h4 class="card-title">${branch.getTheaterName()} </h4>
                        <p class="card-text">Địa Chỉ: ${branch.getTheaterAddress()}</p>
                        <a href="schedule?mid=${requestScope.mid}&branchId=${branch.getIdTheater()}">Chọn</a>
                    </div>
                </div>
            </c:forEach>
        </div>
