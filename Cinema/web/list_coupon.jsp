            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${b}" var="coupon">
                                <tr>
                                    <td>${coupon.getCoupon_id()}</td>
                                    <td>${coupon.getCoupon_code()}</td>
                                    <td>${coupon.getDiscount_percentage()}</td>
                                    <td>${coupon.getExpiry_date()}</td>
                                    <td>
                                        <a href="#editCouponModal" class="edit" data-toggle="modal" 
                                           onclick="takeCouponInfo(${coupon.getCoupon_id()}, '${coupon.getCoupon_code()}', ${coupon.getDiscount_percentage()}, '${coupon.getExpiry_date()}')">
                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                        </a>
<!--                                        <a href="#" class="delete" data-toggle="modal"
                                           onclick="confirmDelete(${coupon.getCoupon_id()})">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="AddCoupon" method="post">
                        <input type="hidden" name="service" value="addCoupon">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="discountPercentage" class="form-control" required>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="EditCoupon" method="post">
                        <input type="hidden" name="service" value="editCoupon">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="number" name="couponID" id="couponEditID" class="form-control" readonly required>
                            </div>
                            <div class="form-group">
                                <label>Coupon Code</label>
                                <input type="text" name="couponCode" id="couponEditCode" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Discount Percentage</label>
                                <input type="number" name="discountPercentage" id="couponEditDiscount" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Expiry Date</label>
                                <input type="date" name="expiryDate" id="couponEditExpiryDate" class="form-control" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
        ...
        <div id="deleteCouponModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" id="couponDeleteID">
...
<script>
    function takeCouponInfo(id, code, discount, expiry) {
        document.getElementById("couponEditID").value = id;
        document.getElementById("couponEditCode").value = code;
        document.getElementById("couponEditDiscount").value = discount;
        document.getElementById("couponEditExpiryDate").value = expiry;
    }
</script>
<script>
    function confirmDelete(couponID) {
        // Gán giá trị ID vào input ẩn trong modal
        document.getElementById('couponDeleteID').value = couponID;
        // Hiển thị modal xác nhận
        $('#deleteCouponModal').modal('show');
    }

// Xử lý sự kiện khi nhấn nút "Delete" trong modal
    document.getElementById('confirmDelete').addEventListener('click', function () {
        let couponID = document.getElementById('couponDeleteID').value;
        window.location.href = "DeleteCoupon?couponID=" + couponID;
    });
</script>
